...
<html>
<head>
    <title>Template Plus | index</title>
...
<div class="wrapper">
    ...
    <header class="main-header">
        ...
        <a href="index2.html" class="logo">
            ...
            <span class="logo-lg"><b>Syllabus</b>Plus</span>
        </a>
                            ...
                            <li>
                                ...
                                <ul class="menu">
                                    ...
                                    <li>
                                        <a href="#">
                                            <div class="pull-left">
                                                <img src="<c:url value="/img/user3-128x128.jpg"/>" class="img-circle" alt="User Image">
                                            </div>
                                            <h4>
                                    ...
                                    <li>
                                        <a href="#">
                                            <div class="pull-left">
                                                <img src="<c:url value="/img/user4-128x128.jpg"/>" class="img-circle" alt="User Image">
                                            </div>
                                            <h4>
                                                Developers
        ...
        <section class="sidebar">
            ...
            <ul class="sidebar-menu">
                ...
                <li class="active treeview">
                    <a href="#">
                        <i class="fa fa-dashboard"></i> <span>数据分析表</span> <i class="fa fa-angle-left pull-right"></i>
                    </a>
                    <ul class="treeview-menu">
                        <li class="active"><a href="index.html"><i class="fa fa-circle-o"></i> 校园总览</a></li>
                        <li><a href="data.html"><i class="fa fa-circle-o"></i> 教室信息</a></li>
                        <li><a href="staff-overview.html"><i class="fa fa-circle-o"></i> 教师信息</a></li>
                        <li><a href="student-overview.html"><i class="fa fa-circle-o"></i> 学生信息</a></li>

                    </ul>
                </li>
                <li class="treeview">
                    <a href="#">
                        <i class="fa fa-warning"></i> <span>Help</span> <i class="fa fa-angle-left pull-right"></i>
                    </a>
                    <ul class="treeview-menu">
                        <li class="active"><a href="index.html"><i class="fa fa-circle-o"></i> Knowledge Base</a></li>
                        <li><a href="index2.html"><i class="fa fa-circle-o"></i> Call for Help</a></li>
                    </ul>
                </li>
            ...
            <div class="row">
                <div class="col-md-6">
                    <div class="box box-success">
                        <div class="box-header with-border">
                            <h3 class="box-title">校园网用户设备比例图</h3>
                        ...
                        <!-- /.box-header -->
                        <div class="box-body">
                            <div id="container_pie_device" style="min-width:400px;height:400px"></div>
                ...
                <div class="col-md-6">
                    <div class="box box-success">
                        <div class="box-header with-border">
                            <h3 class="box-title">校园网用户互联网使用用途分布</h3>
                        ...
                        <!-- /.box-header -->
                        <div class="box-body">
                            <div id="container_bar_internet" style="min-width:400px;height:400px"></div>
    ...
    <footer class="main-footer">
        ...
        <strong>Copyright &copy; 1989-2015 Cyon Australia.</strong> All rights
        reserved.
    </footer>
...
<script src="<c:url value="/plugins/bootstrap-wysihtml5/bootstrap3-wysihtml5.all.js"/>"></script>
...
<script src="<c:url value="/plugins/highcharts/highcharts.js"/>"></script>
...
<script type="text/javascript">
    ...
    $(function () {
        $('#container_pie_device').highcharts({
            chart: {
    ...
    $(function () {
        $('#container_bar_internet').highcharts({
            chart: {
                type: 'bar'
            },
            title: {
            ...
            xAxis: {
                categories: ['新闻类网站', '购物类网站', '娱乐类网站', '游戏类网站', '其他'],
                title: {
                    text: null
                }
            },
